...
#ifndef AliFemtoESDTrackCutPlusJets_H
#define AliFemtoESDTrackCutPlusJets_H

#include "AliESDtrackCuts.h" //for enum with ITS layers
#include "AliFemtoTrackCut.h"
#include "AliFemtoCutMonitorDphiDeta.h" //for max Pt, phimax

#include <utility>


/// \class AliFemtoESDTrackCutPlusJets
...
public:
  ...
  AliFemtoESDTrackCutPlusJets();
  virtual ~AliFemtoESDTrackCutPlusJets();
 ...
 //ML
  void SetMonitor(AliFemtoCutMonitorDphiDeta _monitor);
  AliFemtoCutMonitorDphiDeta GetMonitor();
...
#ifdef __ROOT__
  /// \cond CLASSIMP
  ClassDef(AliFemtoESDTrackCutPlusJets,1);
  /// \endcond
#endif
};


inline void AliFemtoESDTrackCutPlusJets::SetPt(const float& lo, const float& hi){fPt[0]=lo; fPt[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetRapidity(const float& lo,const float& hi){fRapidity[0]=lo; fRapidity[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetEta(const float& lo,const float& hi){fEta[0]=lo; fEta[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetCharge(const int& ch){fCharge = ch;}
inline void AliFemtoESDTrackCutPlusJets::SetPidProbElectron(const float& lo,const float& hi){fPidProbElectron[0]=lo; fPidProbElectron[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetPidProbPion(const float& lo,const float& hi){fPidProbPion[0]=lo; fPidProbPion[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetPidProbKaon(const float& lo,const float& hi){fPidProbKaon[0]=lo; fPidProbKaon[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetPidProbProton(const float& lo,const float& hi){fPidProbProton[0]=lo; fPidProbProton[1]=hi;}
inline void AliFemtoESDTrackCutPlusJets::SetPidProbMuon(const float& lo,const float& hi){fPidProbMuon[0]=lo; fPidProbMuon[1]=hi;}


inline void AliFemtoESDTrackCutPlusJets::SetLabel(const bool& flag){fLabel=flag;}
inline void AliFemtoESDTrackCutPlusJets::SetStatus(const ULong64_t status){fStatus=status;}
inline void AliFemtoESDTrackCutPlusJets::SetminTPCclsF(const short& minTPCclsF){fminTPCclsF=minTPCclsF;}
inline void AliFemtoESDTrackCutPlusJets::SetminTPCncls(const short& s){fminTPCncls=s;}
inline void AliFemtoESDTrackCutPlusJets::SetminITScls(const int& minITScls){fminITScls=minITScls;}
inline void AliFemtoESDTrackCutPlusJets::SetMostProbablePion() { fMostProbable = 2; }
inline void AliFemtoESDTrackCutPlusJets::SetMostProbableKaon() { fMostProbable = 3; }
inline void AliFemtoESDTrackCutPlusJets::SetMostProbableProton() { fMostProbable = 4; }
inline void AliFemtoESDTrackCutPlusJets::SetLeastProbableProton() { fMostProbable = 5; }
//
inline void AliFemtoESDTrackCutPlusJets::SetMostProbableDeuteron() { fMostProbable = 13; }
inline void AliFemtoESDTrackCutPlusJets::SetMostProbableTriton() { fMostProbable = 14; }
inline void AliFemtoESDTrackCutPlusJets::SetMostProbableHe3() { fMostProbable = 15; }
inline void AliFemtoESDTrackCutPlusJets::SetMostProbableAlpha() { fMostProbable = 16; }
//

inline void AliFemtoESDTrackCutPlusJets::SetNoMostProbable() { fMostProbable = 0; }
inline void AliFemtoESDTrackCutPlusJets::SetMostProbable(const int& num) {  fMostProbable =  num; }
inline void AliFemtoESDTrackCutPlusJets::SetMaxITSChiNdof(const float& maxchi) { fMaxITSchiNdof = maxchi; }
inline void AliFemtoESDTrackCutPlusJets::SetMaxTPCChiNdof(const float& maxchi) { fMaxTPCchiNdof = maxchi; }
inline void AliFemtoESDTrackCutPlusJets::SetMaxSigmaToVertex(const float& maxsig) { fMaxSigmaToVertex = maxsig; }
inline void AliFemtoESDTrackCutPlusJets::SetMaxImpactXY(const float& maximpxy) { fMaxImpactXY = maximpxy; }
inline void AliFemtoESDTrackCutPlusJets::SetMinImpactXY(const float& minimpxy) { fMinImpactXY = minimpxy; }
inline void AliFemtoESDTrackCutPlusJets::SetMaxImpactXYPtDep(const float& maxoff, const float& maxnrm, const float& maxpow) { fMaxImpactXYPtOff = maxoff; fMaxImpactXYPtNrm = maxnrm; fMaxImpactXYPtPow = maxpow; }
inline void AliFemtoESDTrackCutPlusJets::SetMaxImpactZ(const float& maximpz) { fMaxImpactZ = maximpz; }
inline void AliFemtoESDTrackCutPlusJets::SetElectronRejection(Bool_t setE) { fElectronRejection = setE; }
