...
#ifndef AliFemtoESDTrackCutMinusJets_H
#define AliFemtoESDTrackCutMinusJets_H
...
///
class AliFemtoESDTrackCutMinusJets : public AliFemtoTrackCut {
public:

  enum PIDMethodType {knSigma=0, kContour=1};
  typedef enum PIDMethodType ReadPIDMethodType;
  AliFemtoESDTrackCutMinusJets();
  virtual ~AliFemtoESDTrackCutMinusJets();
...
inline void AliFemtoESDTrackCutMinusJets::SetPt(const float& lo, const float& hi){fPt[0]=lo; fPt[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetRapidity(const float& lo,const float& hi){fRapidity[0]=lo; fRapidity[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetEta(const float& lo,const float& hi){fEta[0]=lo; fEta[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetCharge(const int& ch){fCharge = ch;}
inline void AliFemtoESDTrackCutMinusJets::SetPidProbElectron(const float& lo,const float& hi){fPidProbElectron[0]=lo; fPidProbElectron[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetPidProbPion(const float& lo,const float& hi){fPidProbPion[0]=lo; fPidProbPion[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetPidProbKaon(const float& lo,const float& hi){fPidProbKaon[0]=lo; fPidProbKaon[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetPidProbProton(const float& lo,const float& hi){fPidProbProton[0]=lo; fPidProbProton[1]=hi;}
inline void AliFemtoESDTrackCutMinusJets::SetPidProbMuon(const float& lo,const float& hi){fPidProbMuon[0]=lo; fPidProbMuon[1]=hi;}


inline void AliFemtoESDTrackCutMinusJets::SetLabel(const bool& flag){fLabel=flag;}
inline void AliFemtoESDTrackCutMinusJets::SetStatus(const ULong64_t status){fStatus=status;}
inline void AliFemtoESDTrackCutMinusJets::SetminTPCclsF(const short& minTPCclsF){fminTPCclsF=minTPCclsF;}
inline void AliFemtoESDTrackCutMinusJets::SetminTPCncls(const short& s){fminTPCncls=s;}
inline void AliFemtoESDTrackCutMinusJets::SetminITScls(const int& minITScls){fminITScls=minITScls;}
inline void AliFemtoESDTrackCutMinusJets::SetMostProbablePion() { fMostProbable = 2; }
inline void AliFemtoESDTrackCutMinusJets::SetMostProbableKaon() { fMostProbable = 3; }
inline void AliFemtoESDTrackCutMinusJets::SetMostProbableProton() { fMostProbable = 4; }
inline void AliFemtoESDTrackCutMinusJets::SetLeastProbableProton() { fMostProbable = 5; }
//
inline void AliFemtoESDTrackCutMinusJets::SetMostProbableDeuteron() { fMostProbable = 13; }
inline void AliFemtoESDTrackCutMinusJets::SetMostProbableTriton() { fMostProbable = 14; }
inline void AliFemtoESDTrackCutMinusJets::SetMostProbableHe3() { fMostProbable = 15; }
inline void AliFemtoESDTrackCutMinusJets::SetMostProbableAlpha() { fMostProbable = 16; }
//

inline void AliFemtoESDTrackCutMinusJets::SetNoMostProbable() { fMostProbable = 0; }
inline void AliFemtoESDTrackCutMinusJets::SetMostProbable(const int& num) {  fMostProbable =  num; }
inline void AliFemtoESDTrackCutMinusJets::SetMaxITSChiNdof(const float& maxchi) { fMaxITSchiNdof = maxchi; }
inline void AliFemtoESDTrackCutMinusJets::SetMaxTPCChiNdof(const float& maxchi) { fMaxTPCchiNdof = maxchi; }
inline void AliFemtoESDTrackCutMinusJets::SetMaxSigmaToVertex(const float& maxsig) { fMaxSigmaToVertex = maxsig; }
inline void AliFemtoESDTrackCutMinusJets::SetMaxImpactXY(const float& maximpxy) { fMaxImpactXY = maximpxy; }
inline void AliFemtoESDTrackCutMinusJets::SetMinImpactXY(const float& minimpxy) { fMinImpactXY = minimpxy; }
inline void AliFemtoESDTrackCutMinusJets::SetMaxImpactXYPtDep(const float& maxoff, const float& maxnrm, const float& maxpow) { fMaxImpactXYPtOff = maxoff; fMaxImpactXYPtNrm = maxnrm; fMaxImpactXYPtPow = maxpow; }
inline void AliFemtoESDTrackCutMinusJets::SetMaxImpactZ(const float& maximpz) { fMaxImpactZ = maximpz; }
inline void AliFemtoESDTrackCutMinusJets::SetElectronRejection(Bool_t setE) { fElectronRejection = setE; }
