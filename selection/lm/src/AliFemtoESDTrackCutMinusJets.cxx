...
AliFemtoESDTrackCutMinusJets::AliFemtoESDTrackCutMinusJets():
...
bool AliFemtoESDTrackCutMinusJets::Pass(const AliFemtoTrack* track)
{
 ...
 //  if(dphi>1.0){
   fNTracksFailed++;
   std::cout<<" bad dphi>1 -----> "<<ptmax<<" dphi "<<dphi<<std::endl;
   return false;
   }

   std::cout<<" after----if--good --- dphi<1----- "<<ptmax<<" dphi "<<dphi<<std::endl;
  /////////////////////////////////////////////////
...
//------------------------------
AliFemtoString AliFemtoESDTrackCutMinusJets::Report()
{
...
TList *AliFemtoESDTrackCutMinusJets::ListSettings()
{
  // return a list of settings in a writable form
  TList *tListSetttings = new TList();
  tListSetttings->AddVector(
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.mass=%f", this->Mass())),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.charge=%i", fCharge)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobpion.minimum=%f", fPidProbPion[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobpion.maximum=%f", fPidProbPion[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobkaon.minimum=%f", fPidProbKaon[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobkaon.maximum=%f", fPidProbKaon[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobproton.minimum=%f", fPidProbProton[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobproton.maximum=%f", fPidProbProton[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobelectron.minimum=%f", fPidProbElectron[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobelectron.maximum=%f", fPidProbElectron[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobMuon.minimum=%f", fPidProbMuon[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pidprobMuon.maximum=%f", fPidProbMuon[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.minimumtpcclusters=%i", fminTPCclsF)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.minimumitsclusters=%i", fminTPCclsF)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pt.minimum=%f", fPt[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.pt.maximum=%f", fPt[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.rapidity.minimum=%f", fRapidity[0])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.rapidity.maximum=%f", fRapidity[1])),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.removekinks=%i", fRemoveKinks)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.maxitschindof=%f", fMaxITSchiNdof)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.maxtpcchindof=%f", fMaxTPCchiNdof)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.maxsigmatovertex=%f", fMaxSigmaToVertex)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.maximpactxy=%f", fMaxImpactXY)),
    new TObjString(Form("AliFemtoESDTrackCutMinusJets.maximpactz=%f", fMaxImpactZ)),
    nullptr
  );
  ...
  if (fMostProbable) {
    tListSetttings->Add(
      new TObjString(
        Form("AliFemtoESDTrackCutMinusJets.mostprobable=%s",
...
void AliFemtoESDTrackCutMinusJets::SetRemoveKinks(const bool& flag)
{
  fRemoveKinks = flag;
}

void AliFemtoESDTrackCutMinusJets::SetRemoveITSFake(const bool& flag)
{
  fRemoveITSFake = flag;
}
...
// 5       -1.125965e+00   2.821170e-01
// 6       2.009036e-01    5.438876e-02
float AliFemtoESDTrackCutMinusJets::PidFractionElectron(float mom) const
{
...
// 1       -4.222208e-01   2.534402e-02
// 2       1.042004e-01    1.503945e-02
float AliFemtoESDTrackCutMinusJets::PidFractionPion(float mom) const
{
...
// 2       -2.996790e-01   1.840964e-02
// 3       6.704652e-02    7.783990e-03
float AliFemtoESDTrackCutMinusJets::PidFractionKaon(float mom) const
{
...
// 2       8.354116e-02    1.997948e-02
// 3       -4.608098e-02   8.336400e-03
float AliFemtoESDTrackCutMinusJets::PidFractionProton(float mom) const
{
...
void AliFemtoESDTrackCutMinusJets::SetMomRangeTOFpidIs(const float& minp, const float& maxp)
{
  fMinPforTOFpid = minp;
  fMaxPforTOFpid = maxp;
}

void AliFemtoESDTrackCutMinusJets::SetMomRangeTPCpidIs(const float& minp, const float& maxp)
{
  fMinPforTPCpid = minp;
  fMaxPforTPCpid = maxp;
}

void AliFemtoESDTrackCutMinusJets::SetMomRangeITSpidIs(const float& minp, const float& maxp)
{
  fMinPforITSpid = minp;
  fMaxPforITSpid = maxp;
}

bool AliFemtoESDTrackCutMinusJets::IsPionTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutMinusJets::IsKaonTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutMinusJets::IsDeuteronTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutMinusJets::IsProtonTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutMinusJets::IsPionTOFTime(float mom, float ttof)
{
...
bool AliFemtoESDTrackCutMinusJets::IsKaonTOFTime(float mom, float ttof)
{
...
bool AliFemtoESDTrackCutMinusJets::IsProtonTOFTime(float mom, float ttof)
{
...
bool AliFemtoESDTrackCutMinusJets::IsKaonTPCdEdxNSigma(float mom, float nsigmaK)
{
//  cout<<" AliFemtoESDTrackCutMinusJets::IsKaonTPCdEdxNSigma "<<mom<<" "<<nsigmaK<<endl;
...
bool AliFemtoESDTrackCutMinusJets::IsKaonTOFNSigma(float mom, float nsigmaK)
{
//  cout<<" AliFemtoESDTrackCutMinusJets::IsKaonTPCdEdxNSigma "<<mom<<" "<<nsigmaK<<endl;
  //fan
...
/*
bool AliFemtoESDTrackCutMinusJets::IsKaonNSigma(float mom, float nsigmaTPCK, float nsigmaTOFK)
{
...
bool AliFemtoESDTrackCutMinusJets::IsPionNSigma(float mom, float nsigmaTPCPi, float nsigmaTOFPi)
{
  if (fNsigmaTPCTOF) {
    if (mom > 0.5) {
      //        if (TMath::Hypot( nsigmaTOFP, nsigmaTPCP )/TMath::Sqrt(2) < 3.0)
...
bool AliFemtoESDTrackCutMinusJets::IsProtonNSigma(float mom, float nsigmaTPCP, float nsigmaTOFP)
{
...
bool AliFemtoESDTrackCutMinusJets::IsDeuteronNSigma(float mom, float massTOFPDG,float sigmaMass, float nsigmaTPCD, float nsigmaTOFD)
{
...
bool AliFemtoESDTrackCutMinusJets::IsTritonNSigma(float mom, float nsigmaTPCT, float nsigmaTOFT)
{
  if (fNsigmaTPCTOF) {
      return false;
  }
...
bool AliFemtoESDTrackCutMinusJets::IsHe3NSigma(float mom, float nsigmaTPCH, float nsigmaTOFH)
{
  if (fNsigmaTPCTOF) {
      return false;
  }
...
bool AliFemtoESDTrackCutMinusJets::IsAlphaNSigma(float mom, float nsigmaTPCA, float nsigmaTOFA)
{
  if (fNsigmaTPCTOF) {
      return false;
  }
...
void AliFemtoESDTrackCutMinusJets::SetPIDMethod(ReadPIDMethodType newMethod)
{
  fPIDMethod = newMethod;
}

void AliFemtoESDTrackCutMinusJets::SetNsigmaTPCTOF(Bool_t nsigma)
{
  fNsigmaTPCTOF = nsigma;
}

void AliFemtoESDTrackCutMinusJets::SetNsigmaTPConly(Bool_t nsigma)
{
  fNsigmaTPConly = nsigma;
}

void AliFemtoESDTrackCutMinusJets::SetNsigma(Double_t nsigma)
{
  fNsigma = nsigma;
}
void AliFemtoESDTrackCutMinusJets::SetNsigmaMass(Double_t nsigma)
{
  fNsigmaMass = nsigma;
}


void AliFemtoESDTrackCutMinusJets::SetClusterRequirementITS(AliESDtrackCuts::Detector det, AliESDtrackCuts::ITSClusterRequirement req)
{
  fCutClusterRequirementITS[det] = req;
}

Bool_t AliFemtoESDTrackCutMinusJets::CheckITSClusterRequirement(AliESDtrackCuts::ITSClusterRequirement req, Bool_t clusterL1, Bool_t clusterL2)
{
...
bool AliFemtoESDTrackCutMinusJets::IsElectron(float nsigmaTPCE, float nsigmaTPCPi,float nsigmaTPCK, float nsigmaTPCP)
{
