...
AddTaskFemto(const char *configMacroName = "ConfigFemtoAnalysisTest.C",
             const char *configMacroParameters = "") {
  // Creates a proton analysis task and adds it to the analysis manager.

  // A. Get the pointer to the existing analysis manager via the static access
  // method.
  //==============================================================================
  ...
  // B. Check the analysis type using the event handlers connected to the
  // analysis
  ...
  //===========================================================================
  //  gSystem->SetIncludePath("-I$ROOTSYS/include  -I./PWG2AOD/AOD
  //  -I./PWG2femtoscopy/FEMTOSCOPY/AliFemto
  //  -I./PWG2femtoscopyUser/FEMTOSCOPY/AliFemtoUser -I$ALICE_ROOT/include");
  ...
  AliAnalysisTaskFemto *taskfemto = new AliAnalysisTaskFemto(
      "TaskFemto", configMacroName, configMacroParameters, false, false, "",
      "ConfigFemtoAnalysisTest");
  ...
  // Get and connect other common input/output containers via the manager as
  // below
  //==============================================================================
  TString outputfile = AliAnalysisManager::GetCommonFileName();
  outputfile += ":PWG2FEMTO";
  AliAnalysisDataContainer *cout_femto =
      mgr->CreateContainer("femtolist", TList::Class(),
