...
#include "AliFemtoESDTrackCutPlusJets.h"
#include <cstdio>
...
AliFemtoESDTrackCutPlusJets::AliFemtoESDTrackCutPlusJets():
...
//------------------------------
bool AliFemtoESDTrackCutPlusJets::Pass(const AliFemtoTrack* track)
{
  //cout<<"AliFemtoESDTrackCutPlusJets::Pass"<<endl;
...
//------------------------------
AliFemtoString AliFemtoESDTrackCutPlusJets::Report()
{
...
TList *AliFemtoESDTrackCutPlusJets::ListSettings()
{
  // return a list of settings in a writable form
  TList *tListSetttings = new TList();
  tListSetttings->AddVector(
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.mass=%f", this->Mass())),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.charge=%i", fCharge)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobpion.minimum=%f", fPidProbPion[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobpion.maximum=%f", fPidProbPion[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobkaon.minimum=%f", fPidProbKaon[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobkaon.maximum=%f", fPidProbKaon[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobproton.minimum=%f", fPidProbProton[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobproton.maximum=%f", fPidProbProton[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobelectron.minimum=%f", fPidProbElectron[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobelectron.maximum=%f", fPidProbElectron[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobMuon.minimum=%f", fPidProbMuon[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pidprobMuon.maximum=%f", fPidProbMuon[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.minimumtpcclusters=%i", fminTPCclsF)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.minimumitsclusters=%i", fminTPCclsF)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pt.minimum=%f", fPt[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.pt.maximum=%f", fPt[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.rapidity.minimum=%f", fRapidity[0])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.rapidity.maximum=%f", fRapidity[1])),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.removekinks=%i", fRemoveKinks)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.maxitschindof=%f", fMaxITSchiNdof)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.maxtpcchindof=%f", fMaxTPCchiNdof)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.maxsigmatovertex=%f", fMaxSigmaToVertex)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.maximpactxy=%f", fMaxImpactXY)),
    new TObjString(Form("AliFemtoESDTrackCutPlusJets.maximpactz=%f", fMaxImpactZ)),
    nullptr
  );
  ...
  if (fMostProbable) {
    tListSetttings->Add(
      new TObjString(
        Form("AliFemtoESDTrackCutPlusJets.mostprobable=%s",
...
void AliFemtoESDTrackCutPlusJets::SetRemoveKinks(const bool& flag)
{
  fRemoveKinks = flag;
}

void AliFemtoESDTrackCutPlusJets::SetRemoveITSFake(const bool& flag)
{
  fRemoveITSFake = flag;
}
...
// 5       -1.125965e+00   2.821170e-01
// 6       2.009036e-01    5.438876e-02
float AliFemtoESDTrackCutPlusJets::PidFractionElectron(float mom) const
{
...
// 1       -4.222208e-01   2.534402e-02
// 2       1.042004e-01    1.503945e-02
float AliFemtoESDTrackCutPlusJets::PidFractionPion(float mom) const
{
...
// 2       -2.996790e-01   1.840964e-02
// 3       6.704652e-02    7.783990e-03
float AliFemtoESDTrackCutPlusJets::PidFractionKaon(float mom) const
{
...
// 2       8.354116e-02    1.997948e-02
// 3       -4.608098e-02   8.336400e-03
float AliFemtoESDTrackCutPlusJets::PidFractionProton(float mom) const
{
...
void AliFemtoESDTrackCutPlusJets::SetMomRangeTOFpidIs(const float& minp, const float& maxp)
{
  fMinPforTOFpid = minp;
  fMaxPforTOFpid = maxp;
}

void AliFemtoESDTrackCutPlusJets::SetMomRangeTPCpidIs(const float& minp, const float& maxp)
{
  fMinPforTPCpid = minp;
  fMaxPforTPCpid = maxp;
}

void AliFemtoESDTrackCutPlusJets::SetMomRangeITSpidIs(const float& minp, const float& maxp)
{
  fMinPforITSpid = minp;
  fMaxPforITSpid = maxp;
}

bool AliFemtoESDTrackCutPlusJets::IsPionTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutPlusJets::IsKaonTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutPlusJets::IsDeuteronTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutPlusJets::IsProtonTPCdEdx(float mom, float dEdx)
{
...
bool AliFemtoESDTrackCutPlusJets::IsPionTOFTime(float mom, float ttof)
{
...
bool AliFemtoESDTrackCutPlusJets::IsKaonTOFTime(float mom, float ttof)
{
...
bool AliFemtoESDTrackCutPlusJets::IsProtonTOFTime(float mom, float ttof)
{
...
bool AliFemtoESDTrackCutPlusJets::IsKaonTPCdEdxNSigma(float mom, float nsigmaK)
{
//  cout<<" AliFemtoESDTrackCutPlusJets::IsKaonTPCdEdxNSigma "<<mom<<" "<<nsigmaK<<endl;
...
bool AliFemtoESDTrackCutPlusJets::IsKaonTOFNSigma(float mom, float nsigmaK)
{
//  cout<<" AliFemtoESDTrackCutPlusJets::IsKaonTPCdEdxNSigma "<<mom<<" "<<nsigmaK<<endl;
  //fan
...
/*
bool AliFemtoESDTrackCutPlusJets::IsKaonNSigma(float mom, float nsigmaTPCK, float nsigmaTOFK)
{
...
bool AliFemtoESDTrackCutPlusJets::IsPionNSigma(float mom, float nsigmaTPCPi, float nsigmaTOFPi)
{
  if (fNsigmaTPCTOF) {
    if (mom > 0.5) {
      //        if (TMath::Hypot( nsigmaTOFP, nsigmaTPCP )/TMath::Sqrt(2) < 3.0)
...
bool AliFemtoESDTrackCutPlusJets::IsProtonNSigma(float mom, float nsigmaTPCP, float nsigmaTOFP)
{
...
bool AliFemtoESDTrackCutPlusJets::IsDeuteronNSigma(float mom, float massTOFPDG,float sigmaMass, float nsigmaTPCD, float nsigmaTOFD)
{
...
bool AliFemtoESDTrackCutPlusJets::IsTritonNSigma(float mom, float nsigmaTPCT, float nsigmaTOFT)
{
  if (fNsigmaTPCTOF) {
      return false;
  }
...
bool AliFemtoESDTrackCutPlusJets::IsHe3NSigma(float mom, float nsigmaTPCH, float nsigmaTOFH)
{
  if (fNsigmaTPCTOF) {
      return false;
  }
...
bool AliFemtoESDTrackCutPlusJets::IsAlphaNSigma(float mom, float nsigmaTPCA, float nsigmaTOFA)
{
  if (fNsigmaTPCTOF) {
      return false;
  }
...
void AliFemtoESDTrackCutPlusJets::SetPIDMethod(ReadPIDMethodType newMethod)
{
  fPIDMethod = newMethod;
}

void AliFemtoESDTrackCutPlusJets::SetNsigmaTPCTOF(Bool_t nsigma)
{
  fNsigmaTPCTOF = nsigma;
}

void AliFemtoESDTrackCutPlusJets::SetNsigmaTPConly(Bool_t nsigma)
{
  fNsigmaTPConly = nsigma;
}

void AliFemtoESDTrackCutPlusJets::SetNsigma(Double_t nsigma)
{
  fNsigma = nsigma;
}
void AliFemtoESDTrackCutPlusJets::SetNsigmaMass(Double_t nsigma)
{
  fNsigmaMass = nsigma;
}


void AliFemtoESDTrackCutPlusJets::SetClusterRequirementITS(AliESDtrackCuts::Detector det, AliESDtrackCuts::ITSClusterRequirement req)
{
  fCutClusterRequirementITS[det] = req;
}

Bool_t AliFemtoESDTrackCutPlusJets::CheckITSClusterRequirement(AliESDtrackCuts::ITSClusterRequirement req, Bool_t clusterL1, Bool_t clusterL2)
{
...
bool AliFemtoESDTrackCutPlusJets::IsElectron(float nsigmaTPCE, float nsigmaTPCPi,float nsigmaTPCK, float nsigmaTPCP)
{
